...
def get_child_boards_list(board) -> list:
    ...
    try: r_tile = board[blank_position[0]][blank_position[1]+1]
    except IndexError: r_tile = None
    try: l_tile = board[blank_position[0]][blank_position[1]-1]
    except IndexError: l_tile = None
    try: u_tile = board[blank_position[0]-1][blank_position[1]]
    except IndexError: u_tile = None
    try: d_tile = board[blank_position[0]+1][blank_position[1]]
    except IndexError: d_tile = None
    ...
    if (blank_position[0] >= 1 and blank_position[1] >= 1 
    ...
    # left edge condition
    elif blank_position[0] > 0 and blank_position[0] < len(board)-1 and blank_position[1] == 0:
        child2 = create_child(board, r_tile, 'r', blank_position)
        child3 = create_child(board, u_tile, 'u', blank_position)
        child4 = create_child(board, d_tile, 'd', blank_position)
    ...
    elif blank_position[0] > 0 and blank_position[0] < len(board)-1 and blank_position[1] == len(board)-1:
        child1 = create_child(board, l_tile, 'l', blank_position)
        child3 = create_child(board, u_tile, 'u', blank_position)
        child4 = create_child(board, d_tile, 'd', blank_position)
    ...
    elif blank_position[0] == len(board)-1 and blank_position[1] < len(board)-1 and blank_position[1] > 0:
        child1 = create_child(board, l_tile, 'l', blank_position)
        child2 = create_child(board, r_tile, 'r', blank_position)
        child3 = create_child(board, u_tile, 'u', blank_position)
    ...
    # top edge condition
    elif blank_position[0] == 0 and blank_position[1] > 0 and blank_position[1] < len(board)-1:
        child1 = create_child(board, l_tile, 'l', blank_position)
        child2 = create_child(board, r_tile, 'r', blank_position)
        child4 = create_child(board, d_tile, 'd', blank_position)
...
def bfs2_euclidean(start_board, goal_board):
    ...
    for tile in start_dict:
        euc_dist = euc_dist + math.dist(start_dict.get(tile), 
                    goal_dict.get(tile))
    ...
    while not queue.empty():
        ...
        for tile in vertex_dict:
            euc_dist = euc_dist + math.dist(vertex_dict.get(tile), goal_dict.get(tile))
        ...
        for next in next_node_list:
            ...
            for tile in next_dict:
                next_euc_dist = euc_dist + math.dist(next_dict.get(tile), goal_dict.get(tile))
...
def bfs2_manhattan(start_board, goal_board):
    ...
    man_dist = 0
    for tile in start_dict:
        man_dist = (man_dist + abs(start_dict.get(tile)[0] - 
                    goal_dict.get(tile)[0]) + 
                    abs(start_dict.get(tile)[1] - 
                    goal_dict.get(tile)[1]))
    ...
    while not queue.empty():
        ...
        man_dist = 0
        for tile in start_dict:
            man_dist = (man_dist + abs(vertex_dict.get(tile)[0] - 
                        goal_dict.get(tile)[0]) + 
                        abs(vertex_dict.get(tile)[1] - 
                        goal_dict.get(tile)[1]))
        ...
        for next in next_node_list:
            ...
            next_man_dist = 0
            for tile in next_dict:
                next_man_dist = (man_dist + 
                            abs(next_dict.get(tile)[0] - 
                            goal_dict.get(tile)[0]) + 
                            abs(next_dict.get(tile)[1] - 
                            goal_dict.get(tile)[1]))
